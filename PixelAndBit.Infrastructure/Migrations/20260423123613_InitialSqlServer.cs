...
namespace PixelAndBit.Infrastructure.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TicketReference = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeviceDescription = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_RepairServices_RepairServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_RepairServiceId",
                table: "Appointments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_TicketReference",
                table: "Bookings",
                column: "TicketReference",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_EmailVerificationCodes_UserId_Email_ConsumedAtUtc_ExpiresAtUtc",
                table: "EmailVerificationCodes",
                columns: new[] { "UserId", "Email", "ConsumedAtUtc", "ExpiresAtUtc" });
